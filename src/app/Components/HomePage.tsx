    ...
    <div className="flex flex-col md:flex-row justify-center items-center w-full md:px-32 pt-4 px-2 md:p-8">
      ...
      <div className="w-full flex flex-row items-center justify-center gap-3 h-full text-black">
        ...
        <Link href={SOCIAL_LINKS.github} target="_blank"
                  rel="noopener noreferrer" className="flex justify-center items-center h-10 w-10 bg-[#FAFAFA] rounded-lg shadow-lg shadow-black/30 hover:shadow-black/60 transform transition-all hover:-translate-y-2 hover:-translate-x-1 hover:-rotate-3 duration-300">
          <svg
        ...
        <Link href={SOCIAL_LINKS.linkedin} target="_blank"
                  rel="noopener noreferrer" className="flex justify-center items-center h-10 w-10 bg-[#FAFAFA] rounded-lg shadow-lg shadow-black/30 hover:shadow-black/60 transform transition-all hover:-translate-y-2 duration-300">
...
function HeroSection() {
  return (
    <div className="flex flex-col items-center justify-center text-center px-4 md:pt-14">
      ...
      <Link href={SOCIAL_LINKS.contact} target="_blank"
                  rel="noopener noreferrer" className="mt-8 px-6 py-3 bg-black text-white rounded-lg text-base sm:text-lg font-plaster font-light shadow-lg shadow-black/20 hover:shadow-black/80 hover:-translate-y-3 transform duration-700 transition-all hover:tracking-widest">
        Contact Me
      </Link>
    </div>
  );
