  ...
  return (
    <div className="flex flex-col items-center justify-center text-center px-4 pt-3 md:pt-14">
      ...
      <Link
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="mt-8 px-6 py-3 bg-black text-white rounded-lg text-base sm:text-lg font-plaster font-light shadow-lg shadow-black/20 hover:shadow-black/80 hover:-translate-y-3 transform duration-700 transition-all hover:tracking-widest"
      >
        Contact Me
      </Link>
    </div>
