...
function Header() {
  return (
    <div className="flex justify-between items-center w-full md:px-32 py-4 px-2 md:p-8">
      <div className="group w-full flex flex-row justify-center gap-x-2 items-center h-full hover:cursor-pointer">
        <Image
      ...
      <div className="w-full flex flex-row items-center justify-center gap-x-3 h-full text-black">
        <div className="hidden md:flex flex-row items-center gap-x-3 pr-5">
